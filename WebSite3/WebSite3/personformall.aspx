...
<form id="form" runat="server">
    ...
    <!--结束时间-->
        <div class="form-group end">
            ...
            <div class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy-m" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
    ...
    <asp:Button runat="server" Text="确定" type="button" class="btn btn-primary"/>
