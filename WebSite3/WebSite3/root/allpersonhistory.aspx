<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allpersonhistory.aspx.cs" Inherits="root_allpersonhistory" %>
            ...
            <div class="tabs">
                <div style="background-color: #72ccf5">
                    ...
                    <div style="background-color: #72ccf5;position:relative;">
                        <a style="margin: 0 5px; white-space: nowrap; font-size: 22px; position: relative; left: 450px;">
                            <asp:TextBox runat="server" class="workinput wicon" ID="date" />
                        </a>
                        <a style="margin: 0 5px; white-space: nowrap; font-size: 22px; position: relative; left: 450px; top:-4px">
