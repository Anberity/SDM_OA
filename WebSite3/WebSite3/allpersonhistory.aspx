            ...
            <div class="tabs">
                <div style="background-color: #72ccf5">
                    <ul>
                        ...
                        <a style="margin: 0 5px; white-space: nowrap; font-size: 28px; position: relative; left: 200px; top: 10px">科室历史工作量查询</a>
                        ...
                        <a style="margin: 0 5px; white-space: nowrap; font-size: 22px; position: relative; left: 520px; top: 10px">
                            <asp:Button Text="注销" class="btn btn-warning" runat="server" ID="logout" OnClick="logout_Click" /></a>
