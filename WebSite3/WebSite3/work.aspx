...
<body style="background-color: #dddddd">
    <div class="row clearfix" id="Tab">
                ...
                <li id="tianxie" class="list-group-item list-group-item-action list-group-item-primary aaa">
                    ...
                    <div class="box">
                        <div class="list-group first" id="list-tab" role="tablist">
                            <span class="list-group-item list-group-item-action active" data-toggle="list" role="tab" aria-controls="home">借调状态更改</span>
                            <span class="list-group-item list-group-item-action" data-toggle="list" role="tab" aria-controls="home">设计工作量</span>
        ...
        <div class="right">
            <iframe id="mainFrame" name="mainFrame" src="./form/OnJob.aspx" scrolling="auto" frameborder="0" height="auto" width="100%" onload='IFrameReSize("mainFrame");'></iframe>
        </div>
    </div>
</body>
...
<script>
    ...
    var arrForm = ['OnJob', 'Design', 'Programming_Picture', 'Debug', 'Manage_Working', 'Daily_Manage', 'LingXing', 'Summary'];
